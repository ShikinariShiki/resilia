export default {
    ...
    landing: {
        ...
        hero2: 'Digital First',
        hero3: 'Responder.',
        heroDesc: 'Learn Psychological First Aid, build resilience, and join a community of citizens prepared for disaster response across Southeast Asia.',
        ...
        usps: {
            ...
            gamifiedDesc: 'Not boring slides. Interactive RPGs, branching dialogue, and quests that make disaster prep engaging and memorable.',
            asean: 'Built for ASEAN',
            aseanDesc: 'Culturally relevant, multilingual, covering region-specific disasters from earthquakes to typhoons to volcanic eruptions.',
            science: 'Science-Backed',
            scienceDesc: 'Based on the WHO Psychological First Aid framework. Every module is grounded in evidence-based practices.',
        ...
        steps: {
            ...
            learn: 'Learn',
            learnDesc: 'Bite-sized modules covering PFA foundations, active listening, de-escalation, and more.',
            practice: 'Practice',
    ...
    home: {
        ...
        rank: {
            next: 'Next rank',
            max: 'Max Rank',
            to_next: '{xp} XP to {next_rank}'
        },
        balance: {
            label: 'ResiCoin balance',
        ...
        missions: {
            ...
            subtitle: 'Complete tasks to earn bonus XP & coins',
            all_complete: '🎉 All daily missions complete!'
        },
        streak: {
            label: 'Login streak',
        ...
        stats: {
            ...
            sub_missions: 'completed today'
        },
        quick_actions: {
            title: 'Quick Actions',
            academy: 'Academy',
            academy_desc: 'Continue learning PFA modules',
            toolkit: 'Toolkit',
            toolkit_desc: 'Free tools & breathing exercises',
            wallet: 'Wallet',
            wallet_desc: 'Manage your ResiCoins',
            analytics: 'Analytics',
            analytics_desc: 'View ASEAN disaster data'
        },
        course_progress: {
        ...
        breathing: {
            ...
            desc: '4-7-8 technique · Reduce anxiety',
        ...
        grounding: {
            ...
            desc: 'Sensory grounding · Stay present',
        ...
        mood: {
            ...
            desc: 'Track how you feel · Build awareness',
            prompt: 'How are you feeling right now?',
            logged: 'Mood logged! {emoji}',
            recent: 'Recent'
        },
        meditation: {
            title: 'Guided Meditation',
            desc: 'Timed mindfulness · Inner peace',
            start: '▶ Start',
            stop: '⬜ Stop'
        },
        affirmations: {
            title: 'Positive Affirmations',
            desc: 'Daily strength · Self-belief',
            new: '✨ New Affirmation'
        },
        emotionWheel: {
            title: 'Emotion Wheel',
            desc: 'Name what you feel · Build EQ'
        },
        journal: {
            title: 'Quick Journal',
            desc: 'Write freely · Process thoughts',
            placeholder: 'What\'s on your mind today...',
            save: '📝 Save Entry',
            saved: '✓ Saved!',
            entries: '{count} entries written'
        },
        contacts: {
    ...
    wallet: {
        ...
        stats: {
            responders: 'Active Responders',
            modules: 'Modules Completed',
            funds: 'Community Funds (RC)',
            growth: 'Last 7 days'
        },
        chartTitle: 'Deployment Activity (30 Days)',
        quickLinks: 'Quick Links',
        dailyMissions: 'Daily Missions',
        dailyDesc: 'Earn XP and maintain your streak',
        aseanData: 'ASEAN Country Data',
        table: {
            country: 'Country',
            pop: 'Pop.',
            gdp: 'GDP/Cap',
    ...
    landing: {
        ...
        roadmapTitle: 'Your Path to Mastery',
        roadmapDesc: 'Progress through ranks, earn perks, and rise in the Digital Reserve Corps.',
        voicesTitle: 'Voices from the Field',
        ...
        steps: {
            ...
            levelUp: 'Level Up',
            levelUpDesc: 'Earn XP, climb ranks, earn perks, and become a certified Digital First Responder.'
        },
        title: 'Academy 🎓',
        subtitle: 'Master Psychological First Aid and become a certified community responder.',
        startChapter: 'Start Chapter',
